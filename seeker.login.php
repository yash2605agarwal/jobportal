...
<head>
	...
	<script type="text/javascript" src="js/login.check.js">
		 function SeekerLogin(){
		 	var a=   document.form_seekerlogin.captcha.value;
		 	alert(a);
		 	var b = "<?php echo $sessionCaptcha ?>"; 
		 	if(a==b){
		 		return true;
		 	}
		 	else{
			...
			<font style="color: #CCBA96">
				...
				<br />
					...
					<div>
						...
						<!-- End of Password Div -->
						<div>
							<div align="right" class="div_left"><font color="#FF0000">*&nbsp;</font>Type Captcha</div>
							<div align="center" class="div_center"><b>:</b></div>
							<div align="left" class="div_right">
						    <input type="text" name="captcha"><img src="cap.php"><br>
							</div>
						</div><br /><br />
